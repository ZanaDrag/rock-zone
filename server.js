...
const TRACKS = [
  ...
  },
 {
  ...
  },
   {
    ...
    lyrics: [
      { time: 0,   text: "♪" },
      { time: 14,  text: "Трогательно ножмчком пытать свою плоть" },
      { time: 0,   text: "Трогательно ножичком пытать свою плоть" },
      { time: 14,  text: "До крови прищемиить добровольные пальцы" },
      { time: 18,  text: "Отважно смакуя леденцы на палочке" },
      { time: 22,  text: "Целеустремлённо набивать карманы" },
      { time: 25,  text: "Мёртвыми мышатами, живыми хуями" },
      { time: 29,  text: "Шоколадными конфетами" },
      { time: 42,  text: "И нерукотворными пиздюлями" },
      { time: 46,  text: "На патриарзальной свалке устраревших понятий" },
      { time: 49,  text: "Использованных образов и вежливых слов" },
      { time: 53,  text: "Покончив с собою, уничтожить весь мир" },
      { time: 56,  text: "Покнчить с собою – уничтожить весь мир" },
      { time: 61,  text: "Вечность пахнет нефтью..." },
      { time: 63,  text: "Вечность пахнет нефтью..." },
      { time: 68,  text: "Словно иней, сердобольный смех" },
      { time: 68,  text: "Словно иней, сердобольный смех" },
      { time: 68,  text: "Словно иней, сердобольный смех" },
      { time: 68,  text: "Словно валиться на, на, на..." },
      { time: 75,  text: "Русское поле экспериментов" },
      { time: 75,  text: "Русское поле экспериментов" },
      { time: 75,  text: "Русское поле экспериментов" },
      { time: 75,  text: "Русское поле экспериментов" },
      { time: 78,  text: "География подлинности, орфография ненависти" },
      { time: 81,  text: "Апология невежества, мифология оптимизма" },
      { time: 85,  text: "Законы гаубицы благонравия" },
      { time: 88,  text: "Знатное пиршество благоразумия" },
      { time: 93,  text: "Устами ребёнка глаголет яма" },
      { time: 95,  text: "Устами ребёнка глаголет пуля" },
      { time: 61,  text: "Вечность пахнет нефтью..." },
      { time: 63,  text: "Вечность пахнет нефтью..." },
      { time: 68,  text: "Словно иней, сердобольный смех" },
      { time: 68,  text: "Словно иней, сердобольный смех" },
      ...
      { time: 75,  text: "Русское поле экспериментов" },
      { time: 75,  text: "Русское поле экспериментов" },
      { time: 99,  text: "Как мы дойдём до конца!" },
      { time: 101, text: "♪" },
      { time: 115, text: "И сбылись мечты." },
      { time: 119, text: "В этом тёмном мире," },
      { time: 123, text: "Только я и ты," },
      { time: 126, text: "Мы в одной могиле." },
      { time: 129, text: "«Мы однажды оживём во снах!»" },
      { time: 134, text: "Ты говорила:" },
      { time: 136, text: "«Когда тело превратится в прах," },
      { time: 141, text: "Боли не будет и развеется страх!»" },
      { time: 148, text: "На тебя гляжу во мгле," },
      { time: 151, text: "Мёртвой рукой прикасаюсь к тебе," },
      { time: 155, text: "Ты пушинка, ты на небе" },
      { time: 158, text: "Я же, как камень, и я на земле." },
      { time: 162, text: "Если сможешь, то ответь –" },
      { time: 165, text: "Что по ту сторону сна видишь ты?" },
      { time: 169, text: "И сбылись ли, и сбылись ли" },
      { time: 172, text: "Странные эти мечты?" },
      { time: 174, text: "а половину текста профукали₍^. .^₎⟆" },
      { time: 188,  text: "Презираю этот мир!" },
      { time: 191,  text: "Миром его называть не хочу." },
      { time: 195,  text: "Ты со мною, я с тобою," },
      { time: 198,  text: "Ты всё болтаешь, а я всё молчу," },
      { time: 201,  text: "Я бросаю вызов всем" },
      { time: 205,  text: "И своего я не помню лица" },
      { time: 208,  text: "Мир увидит, пусть увидит," },
      { time: 212,  text: "Как мы дойдём до конца!" },
      { time: 218,  text: "Мои мелкие радости больше не окупают неприятные" },
      { time: 223,  text: "Моменты той действительности, которая меня окружает..." }
   ]
  },
   {
    id: 54,
    ...
    lyrics: [
      { time: 0,   text: "♪" },
      { time: 14,  text: "В тебя доверчиво плюнет с неба мразь," },
      { time: 0,   text: "Ветра, часы и телефоны сменят власть," },
      { time: 23,  text: "Твоё утраченное время не придёт," },
      { time: 26,  text: "Оно чужое – у тебя лишь только имя своё." },
      { time: 28,  text: "Всё оно чужое." },
      { time: 31,  text: "– У тебя лишь только имя своё." },
      { time: 28,  text: "Всё оно чужое." },
      { time: 31,  text: "– Ведь осталось только имя своё." },
      { time: 28,  text: "Всё оно чужое." },
      { time: 31,  text: "– У тебя лишь только имя своё." },
      { time: 28,  text: "Всё оно чужое." },
      { time: 31,  text: "– У тебя лишь только имя своё." },
      { time: 0,   text: "♪" },
      { time: 33,  text: "Шальная пуля полетела восвоясь" },
      { time: 37,  text: "В мозгах налипла, пожелтела, взвыла грязь" },
      { time: 41,  text: "Сосед узнал, увидел, вскрикнул – я зверьё!" },
      { time: 46,  text: "Он засмеялся потому, что всё давно не своё." },
      { time: 51,  text: "Всё оно чужое." },
      { time: 57,  text: "– Всё давным-давноы не своё." },
      { time: 51,  text: "Всё оно чужое." },
      { time: 57,  text: "– Всё давным-давноы не своё." },
      { time: 51,  text: "Всё оно чужое." },
      { time: 57,  text: "– Всё давным-давноы не своё." },
      { time: 51,  text: "Всё оно чужое." },
      { time: 57,  text: "– Всё давным-давноы не своё." },
      { time: 0,   text: "вай красота" },
      { time: 62,  text: "Вылазят боги из заветного дупла" },
      { time: 65,  text: "Растут герои, как лавина, как ботва" },
      { time: 68,  text: "Нырнёт раскрашенная птица в вороньё," },
      { time: 71,  text: "Но перед тем, как приземлиться – вспомни имя своё." },
      { time: 74,  text: "Всё оно чужое." },
      { time: 76,  text: "– Только помни имя своё." },
      { time: 74,  text: "Всё оно чужое." },
      { time: 80,  text: "– Единственное имя своё." },
      { time: 74,  text: "Всё оно чужое." },
      { time: 82,  text: "– Настоящее имя своё." },
      { time: 74,  text: "Всё оно чужое." },
      { time: 86,  text: "– Подлинное имя своё." },
      { time: 74,  text: "Всё оно чужое." },
      { time: 91,  text: "– Истинное имя своё." },
      { time: 74,  text: "Всё оно чужое." },
      { time: 97,  text: "– Только помни имя своё." },
      { time: 74,  text: "Всё оно чужое." },
      { time: 97,  text: "– Только помни имя своё." },
      { time: 74,  text: "Всё оно чужое." },
      { time: 97,  text: "– Только помни имя своё." },
  ...
  },
   {
    ...
    lyrics: [
      { time: 0,   text: "♪" },
      { time: 14,  text: "Кровь, погони, страсть…" },
      { time: 18,  text: "Жить – любой ценою," },
      { time: 22,  text: "Я не смел упасть," },
      { time: 25,  text: "Ты была со мною." },
      { time: 29,  text: "♪" },
      { time: 42,  text: "Эта западня" },
      { time: 46,  text: "Гибельна, но всё же," },
      { time: 49,  text: "В смерть не верю я," },
      { time: 53,  text: "Ты не веришь тоже!" },
      { time: 56,  text: "Лишь два цвета различаю я –" },
      { time: 61,  text: "Чёрный и белый." },
      { time: 63,  text: "А в моих патронах – суть моя," },
      { time: 68,  text: "Больше ничто не остановит меня!" },
      { time: 75,  text: "Презираю этот мир!" },
      { time: 78,  text: "Миром его называть не хочу." },
      { time: 81,  text: "Ты со мною, я с тобою," },
      { time: 85,  text: "Ты всё болтаешь, а я всё молчу." },
      { time: 88,  text: "Я бросаю вызов всем" },
      { time: 93,  text: "И своего я не помню лица." },
      { time: 95,  text: "Мир увидит, пусть увидит," },
      { time: 99,  text: "Как мы дойдём до конца!" },
      { time: 101, text: "♪" },
      { time: 115, text: "И сбылись мечты." },
      { time: 119, text: "В этом тёмном мире," },
