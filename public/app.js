...
function getDemoTracks() {
  return [
    ...
    { id:3, title:'Долгая счастливая жизнь', artist:'Гражданская Оборона',  album:'Долгая счастливая жизнь', duration:325, cover:'/images/cover16.jpg', audio:'/api/stream/42', genre:'Гр.Об',
